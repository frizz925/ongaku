...
#define STREAMCFG_DEFAULT_FLAGS (STREAMCFG_FLAG_CODEC_OPUS | STREAMCFG_FLAG_ENCRYPTED)
#define STREAMCFG_FLAG_DUPLEX (STREAMCFG_FLAG_INPUT | STREAMCFG_FLAG_OUTPUT)
#define STREAMCFG_DIRECTION_MASK STREAMCFG_FLAG_DUPLEX
